                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '1xqy69ln' /* أدخل رقم هاتفك المحمول..... */,
                                              ),
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '9s0vvjlt' /* أوافق على شروط الاستخدام وسياس... */,
                                              ),
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            final phoneNumberVal =
                                                '+970${_model.textFieldPhoneNumberController.text}';
