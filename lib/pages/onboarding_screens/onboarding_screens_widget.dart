...
import '/pages/phone_sign_up/phone_sign_up_widget.dart';
...
import 'onboarding_screens_model.dart';
export 'onboarding_screens_model.dart';
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Image.asset(
                                'assets/images/Construction_worker-rafiki.png',
                                width: 300.0,
                                height: 300.0,
                                fit: BoxFit.cover,
                              ),
                                      ...
                                      child: Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '52ramgz3' /* انجاز الاعمال باستخدام الهاتف */,
                                          ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '8pwxetwc' /* تواصل مع الحرفي وتتبع العمل  
... */
                                            ,
                                          ),
                                          style: FlutterFlowTheme.of(context)
...
وقم باختيار... */
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Image.asset(
                                'assets/images/Construction_worker-amico.png',
                                width: 300.0,
                                height: 300.0,
                                fit: BoxFit.cover,
                              ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'f97m5tno' /* انجاز الاعمال باستخدام الهاتف */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .displayMedium
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: Align(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '24183xx4' /* تواصل مع الحرفي وتتبع العمل 
و... */
                                            ,
                                          ),
                                          textAlign: TextAlign.center,
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PhoneSignUpWidget(),
                      ),
                    );
                  },
                  text: FFLocalizations.of(context).getText(
