...
class NavBarCraftsmanModel extends FlutterFlowModel {
  ///  Local state fields for this component.

  Color? home = const Color(0xFF57636C);

  Color? profile = const Color(0xFF57636C);

  Color? chat = const Color(0xFF57636C);

  Color? myJob = const Color(0xFF57636C);
